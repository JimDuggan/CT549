...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . kdw33falps ) , 0 , 0 , 1 } ,
{ ( char_T * ) ( & rtDW . an14gvyo31 . LoggedData ) , 11 , 0 , 1 } } ; static
DataTypeTransitionTable rtBTransTable = { 2U , rtBTransitions } ; static
DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP . INITStock
) , 0 , 0 , 2 } } ; static DataTypeTransitionTable rtPTransTable = { 1U ,
rtPTransitions } ;
